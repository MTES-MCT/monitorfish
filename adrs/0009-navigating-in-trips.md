...
- La date qui a du sens d'un point de vue usager est la date d'activité. C'est sur cette date que la logique de navigation (marée "suivante", marée "précédente") doit s'appuyer, ainsi que la sélection des positions CMS correspondant à la marée.
