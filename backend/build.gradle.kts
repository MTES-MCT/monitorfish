...
dependencies {
    ...
    api("org.springframework.boot:spring-boot-starter-json:3.5.0")
    ...
    api("org.springframework.boot:spring-boot-starter-cache:3.5.0")
    ...
    api("io.ktor:ktor-client-core-jvm:3.1.3")
    api("io.ktor:ktor-client-java-jvm:3.1.3")
    api("io.ktor:ktor-client-content-negotiation-jvm:3.1.3")
    api("io.ktor:ktor-serialization-kotlinx-json-jvm:3.1.3")
    ...
    api("io.sentry:sentry-log4j2:8.13.2")
    implementation("org.springframework.cloud:spring-cloud-gateway-mvc:4.3.0")
    runtimeOnly("org.postgresql:postgresql:42.7.6")
    testImplementation("io.ktor:ktor-client-mock-jvm:3.1.3")
