...
dependencies {
    ...
    api("org.springframework.security:spring-security-oauth2-resource-server:6.5.2")
    api("org.springframework.security:spring-security-oauth2-jose:6.5.2")
    api("org.springframework.boot:spring-boot-starter-json:3.5.4")
    api("org.springframework.boot:spring-boot-starter-security:3.5.4")
    api("org.springframework.boot:spring-boot-starter-data-jpa:3.5.4")
    api("org.springframework.boot:spring-boot-configuration-processor:3.5.4")
    api("org.springframework.boot:spring-boot-starter-cache:3.5.4")
    ...
    api("io.ktor:ktor-client-core-jvm:3.2.3")
    api("io.ktor:ktor-client-java-jvm:3.2.3")
    api("io.ktor:ktor-client-content-negotiation-jvm:3.2.3")
    api("io.ktor:ktor-serialization-kotlinx-json-jvm:3.2.3")
    ...
    api("org.flywaydb:flyway-database-postgresql:11.10.5")
