...
dependencies {
    api("org.springframework.boot:spring-boot-starter-web:4.0.5")
    ...
    api("org.springframework.boot:spring-boot-starter-json:4.0.5")
    api("org.springframework.boot:spring-boot-starter-security:4.0.5")
    api("org.springframework.boot:spring-boot-starter-data-jpa:4.0.5")
    api("org.springframework.boot:spring-boot-configuration-processor:4.0.5")
    api("org.springframework.boot:spring-boot-starter-cache:4.0.5")
    api("org.springframework.boot:spring-boot-starter-log4j2:4.0.5")
    implementation("org.springframework.boot:spring-boot-starter-oauth2-client")
    runtimeOnly("org.springframework.boot:spring-boot-devtools:4.0.5")
    api("org.jetbrains.kotlinx:kotlinx-serialization-json:1.10.0")
    api("io.ktor:ktor-client-core-jvm:3.4.0")
    api("io.ktor:ktor-client-java-jvm:3.4.0")
    api("io.ktor:ktor-client-content-negotiation-jvm:3.4.0")
