...
dependencies {
    ...
    api("org.springframework.security:spring-security-oauth2-resource-server:6.5.1")
    api("org.springframework.security:spring-security-oauth2-jose:6.5.1")
    api("org.springframework.boot:spring-boot-starter-actuator:3.5.3")
    api("org.springframework.boot:spring-boot-starter-json:3.5.3")
    api("org.springframework.boot:spring-boot-starter-security:3.5.3")
    ...
    api("org.springframework.boot:spring-boot-starter-cache:3.5.3")
    api("org.springframework.boot:spring-boot-starter-log4j2:3.5.3")
    runtimeOnly("org.springframework.boot:spring-boot-devtools:3.5.3")
    api("org.jetbrains.kotlinx:kotlinx-serialization-json:1.9.0")
    api("io.ktor:ktor-client-core-jvm:3.2.0")
    api("io.ktor:ktor-client-java-jvm:3.2.0")
    api("io.ktor:ktor-client-content-negotiation-jvm:3.2.0")
    api("io.ktor:ktor-serialization-kotlinx-json-jvm:3.2.0")
    ...
    api("org.flywaydb:flyway-core:11.10.0")
    api("org.flywaydb:flyway-database-postgresql:11.10.0")
    ...
    api("io.sentry:sentry:8.16.0")
    api("io.sentry:sentry-log4j2:8.16.0")
    implementation("org.springframework.cloud:spring-cloud-gateway-mvc:4.3.0")
    runtimeOnly("org.postgresql:postgresql:42.7.7")
    testImplementation("io.ktor:ktor-client-mock-jvm:3.2.0")
