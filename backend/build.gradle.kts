...
dependencies {
    ...
    api("org.springframework.boot:spring-boot-starter-actuator:3.3.4")
    api("org.springframework.boot:spring-boot-starter-json:3.3.4")
    ...
    api("org.springframework.boot:spring-boot-configuration-processor:3.3.4")
    api("org.springframework.boot:spring-boot-starter-cache:3.3.4")
    api("org.springframework.boot:spring-boot-starter-log4j2:3.3.4")
