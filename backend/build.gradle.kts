...
dependencies {
    ...
    api("org.springframework.boot:spring-boot-starter-json:3.4.2")
    ...
    api("org.springframework.boot:spring-boot-starter-cache:3.4.2")
    api("org.springframework.boot:spring-boot-starter-log4j2:3.4.2")
    ...
    api("org.hibernate:hibernate-spatial:6.6.5.Final")
