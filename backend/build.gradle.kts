...
dependencies {
    ...
    api("org.springframework.boot:spring-boot-configuration-processor:4.0.1")
    api("org.springframework.boot:spring-boot-starter-cache:4.0.1")
    api("org.springframework.boot:spring-boot-starter-log4j2:4.0.1")
    implementation("org.springframework.boot:spring-boot-starter-oauth2-client")
    runtimeOnly("org.springframework.boot:spring-boot-devtools:4.0.1")
