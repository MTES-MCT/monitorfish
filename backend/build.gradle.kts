...
dependencies {
    ...
    api("org.springframework.security:spring-security-oauth2-resource-server:6.4.3")
    api("org.springframework.security:spring-security-oauth2-jose:6.4.3")
    api("org.springframework.boot:spring-boot-starter-actuator:3.4.3")
    api("org.springframework.boot:spring-boot-starter-json:3.4.3")
    api("org.springframework.boot:spring-boot-starter-security:3.4.3")
    api("org.springframework.boot:spring-boot-starter-data-jpa:3.4.3")
    api("org.springframework.boot:spring-boot-configuration-processor:3.4.3")
    api("org.springframework.boot:spring-boot-starter-cache:3.4.3")
    api("org.springframework.boot:spring-boot-starter-log4j2:3.4.3")
    runtimeOnly("org.springframework.boot:spring-boot-devtools:3.4.3")
    api("org.jetbrains.kotlinx:kotlinx-serialization-json:1.8.0")
    api("io.ktor:ktor-client-core-jvm:3.1.1")
    api("io.ktor:ktor-client-java-jvm:3.1.1")
    api("io.ktor:ktor-client-content-negotiation-jvm:3.1.1")
    api("io.ktor:ktor-serialization-kotlinx-json-jvm:3.1.1")
    ...
    api("org.flywaydb:flyway-core:11.3.4")
    ...
    api("org.hibernate:hibernate-spatial:6.6.9.Final")
    api("io.sentry:sentry:8.3.0")
    api("io.sentry:sentry-log4j2:8.3.0")
