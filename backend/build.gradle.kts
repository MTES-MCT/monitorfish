...
dependencies {
    ...
    api("org.springframework.security:spring-security-oauth2-resource-server:6.4.4")
    api("org.springframework.security:spring-security-oauth2-jose:6.4.4")
    api("org.springframework.boot:spring-boot-starter-actuator:3.4.4")
    api("org.springframework.boot:spring-boot-starter-json:3.4.4")
    ...
    api("org.springframework.boot:spring-boot-starter-cache:3.4.4")
    api("org.springframework.boot:spring-boot-starter-log4j2:3.4.4")
    runtimeOnly("org.springframework.boot:spring-boot-devtools:3.4.4")
    ...
    api("org.flywaydb:flyway-core:11.5.0")
    api("org.flywaydb:flyway-database-postgresql:11.5.0")
    ...
    api("org.hibernate:hibernate-spatial:6.6.12.Final")
    api("io.sentry:sentry:8.6.0")
    api("io.sentry:sentry-log4j2:8.6.0")
