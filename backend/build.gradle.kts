...
dependencies {
    ...
    api("org.springframework.boot:spring-boot-starter-security:4.0.3")
    api("org.springframework.boot:spring-boot-starter-data-jpa:4.0.3")
    api("org.springframework.boot:spring-boot-configuration-processor:4.0.3")
    ...
    runtimeOnly("org.springframework.boot:spring-boot-devtools:4.0.3")
