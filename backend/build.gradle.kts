...
dependencies {
    ...
    api("io.ktor:ktor-client-core-jvm:3.3.1")
    api("io.ktor:ktor-client-java-jvm:3.3.1")
    api("io.ktor:ktor-client-content-negotiation-jvm:3.3.1")
    api("io.ktor:ktor-serialization-kotlinx-json-jvm:3.3.1")
    ...
    testImplementation("io.ktor:ktor-client-mock-jvm:3.3.1")
