...
dependencies {
    ...
    api("org.springframework.boot:spring-boot-starter-actuator:3.4.5")
    api("org.springframework.boot:spring-boot-starter-json:3.4.5")
    ...
    api("org.springframework.boot:spring-boot-configuration-processor:3.4.5")
    api("org.springframework.boot:spring-boot-starter-cache:3.4.5")
    api("org.springframework.boot:spring-boot-starter-log4j2:3.4.5")
    runtimeOnly("org.springframework.boot:spring-boot-devtools:3.4.5")
    api("org.jetbrains.kotlinx:kotlinx-serialization-json:1.8.1")
    api("io.ktor:ktor-client-core-jvm:3.1.2")
    api("io.ktor:ktor-client-java-jvm:3.1.2")
    api("io.ktor:ktor-client-content-negotiation-jvm:3.1.2")
    ...
    api("org.hibernate:hibernate-spatial:6.6.13.Final")
    api("io.sentry:sentry:8.11.1")
    api("io.sentry:sentry-log4j2:8.11.1")
    implementation("org.springframework.cloud:spring-cloud-gateway-mvc:4.2.2")
    runtimeOnly("org.postgresql:postgresql:42.7.5")
    testImplementation("io.ktor:ktor-client-mock-jvm:3.1.2")
