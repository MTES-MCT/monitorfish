...
dependencies {
    ...
    api("org.springframework.boot:spring-boot-starter-json:3.4.0")
    api("org.springframework.boot:spring-boot-starter-security:3.4.0")
    api("org.springframework.boot:spring-boot-starter-data-jpa:3.4.0")
    api("org.springframework.boot:spring-boot-configuration-processor:3.4.0")
    api("org.springframework.boot:spring-boot-starter-cache:3.4.0")
    api("org.springframework.boot:spring-boot-starter-log4j2:3.4.0")
    runtimeOnly("org.springframework.boot:spring-boot-devtools:3.4.0")
