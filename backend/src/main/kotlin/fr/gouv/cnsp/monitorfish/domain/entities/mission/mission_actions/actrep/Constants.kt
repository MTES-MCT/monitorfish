...
val MEDITERRANEAN_AND_EASTERN_ATLANTIC_SPECIES: List<FaoZonesAndSpecy> =
...
val NORTH_SEA_SPECIES: List<FaoZonesAndSpecy> =
    generateSpeciesWithFaoCode(
...
val WESTERN_WATERS_SPECIES: List<FaoZonesAndSpecy> =
    listOf(
