...
class RequestNotification(private val beaconMalfunctionsRepository: BeaconMalfunctionsRepository) {
    fun execute(id: Int, notificationRequested: BeaconMalfunctionNotificationType, requestedNotificationForeignFmcCode: String? = null) {
        ...
        when (notificationRequested) {
            BeaconMalfunctionNotificationType.MALFUNCTION_NOTIFICATION_TO_FOREIGN_FMC -> {
                ...
                beaconMalfunctionsRepository.requestNotification(id, notificationRequested, requestedNotificationForeignFmcCode)
            }
