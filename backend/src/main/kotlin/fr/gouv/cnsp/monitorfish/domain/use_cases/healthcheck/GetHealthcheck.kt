...
class GetHealthcheck(
    ...
    private val recentPositionsMetricsRepository: RecentPositionsMetricsRepository,
) {
    fun execute(): Health {
        ...
        val suddenDropOfPositionsReceived = recentPositionsMetricsRepository.findSuddenDropOfPositionsReceived()
        ...
        return Health(
            ...
            suddenDropOfPositionsReceived = suddenDropOfPositionsReceived,
        )
    }
}
