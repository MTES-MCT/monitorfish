    ...
    companion object {
        fun fromBeaconMalfunctionWithDetails(beaconMalfunctionWithDetails: BeaconMalfunctionWithDetails): BeaconMalfunctionWithDetailsDataOutput {
            return BeaconMalfunctionWithDetailsDataOutput(
                    beaconMalfunction = BeaconMalfunctionDataOutput.fromBeaconMalfunction(beaconMalfunctionWithDetails.beaconMalfunction),
                    comments = beaconMalfunctionWithDetails.comments.map { BeaconMalfunctionCommentDataOutput.fromBeaconMalfunctionComment(it) },
                    actions = beaconMalfunctionWithDetails.actions.map { BeaconMalfunctionActionDataOutput.fromBeaconMalfunctionAction(it) }
            )
        }
    }
}
