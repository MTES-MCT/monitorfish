    ...
    companion object {
        fun fromEnriched(enriched: EnrichedMissionAction) =
            PublicMissionActionDataOutput(
                ...
                proprietorName = enriched.vessel?.proprietorName,
                proprietorPhones = enriched.vessel?.proprietorPhones,
                proprietorEmails = enriched.vessel?.proprietorEmails,
                proprietorNationality = enriched.vessel?.proprietorNationality,
                proprietorAddress = enriched.vessel?.proprietorAddress,
                chartererName = enriched.vessel?.operatorName,
                chartererPhones = enriched.vessel?.operatorPhones,
                chartererEmail = enriched.vessel?.operatorEmail,
                chartererNationality = enriched.vessel?.operatorNationality,
                chartererAddress = enriched.vessel?.operatorAddress,
