            ...
            when (reportingType) {
                ReportingType.ALERT -> {
                    ...
                    Reporting.Alert(
                        ...
                        cfr = entity.cfr,
                        externalMarker = entity.externalMarker,
                        ircs = entity.ircs,
                        mmsi = entity.mmsi,
                        imo = entity.imo,
                        length = entity.length,
                        gearCode = entity.gearCode,
                ...
                ReportingType.INFRACTION_SUSPICION -> {
                    ...
                    Reporting.InfractionSuspicion(
                        ...
                        validationDate = entity.validationDate,
                        expirationDate = entity.expirationDate,
                        validityOption = entity.validityOption,
                        archivingDate = entity.archivingDate,
                        isArchived = entity.isArchived,
                        isDeleted = entity.isDeleted,
                        isIUU = entity.isIuu,
                        ...
                        otherSourceType = infractionSuspicionValue.otherSourceType,
                ...
                ReportingType.OBSERVATION -> {
                    ...
                    Reporting.Observation(
                        ...
                        otherSourceType = observationValue.otherSourceType,
