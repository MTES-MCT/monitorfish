...
ALTER TABLE public.ers_messages
    DROP CONSTRAINT IF EXISTS ers_messages_pkey;
ALTER TABLE ONLY public.ers_messages
    ADD CONSTRAINT ers_messages_pkey PRIMARY KEY (operation_number);
...
ALTER TABLE ONLY public.ers
    ADD CONSTRAINT ers_pkey PRIMARY KEY (id);
