...
('FAK000999999','CALLME','DONTSINK', 'INTERNAL_REFERENCE_NUMBER', 'PHENOMENE', 'ACTIVITY_DETECTED', 'INITIAL_ENCOUNTER', true, NOW() - ('1 WEEK')::interval, null, NOW()),
('FAK000999999','CALLME','DONTSINK', 'INTERNAL_REFERENCE_NUMBER', 'PHENOMENE', 'AT_SEA', 'END_OF_MALFUNCTION', true, NOW() - ('8 WEEKS')::interval, NOW() - ('6 WEEKS')::interval, NOW() - ('6 WEEKS')::interval),
...
('FR263465414','IR123','08FR65465', 'EXTERNAL_REFERENCE_NUMBER','LE b@TO 2', 'AT_PORT', 'ARCHIVED', true, NOW() - ('3 WEEK')::interval, null, NOW() - ('2 WEEK')::interval),
