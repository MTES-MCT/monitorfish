...
('FAK000999999','CALLME','DONTSINK', 'INTERNAL_REFERENCE_NUMBER', 'PHENOMENE', 'AT_SEA', 'RESUMED_TRANSMISSION', true, NOW() - ('8 WEEKS')::interval, NOW() - ('6 WEEKS')::interval, NOW() - ('6 WEEKS')::interval),
