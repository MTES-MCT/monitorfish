INSERT INTO beacon_statuses (internal_reference_number, ircs, external_reference_number, vessel_identifier, vessel_name, vessel_status, stage, priority, malfunction_start_date_utc, malfunction_end_date_utc, vessel_status_last_modification_date_utc) VALUES
...
('FAK000999999','CALLME','DONTSINK', 'INTERNAL_REFERENCE_NUMBER', 'PHENOMENE', 'TECHNICAL_STOP', 'RESUMED_TRANSMISSION', true, NOW() - ('8 WEEKS')::interval, NOW() - ('6 WEEKS')::interval, NOW() - ('6 WEEKS')::interval),
