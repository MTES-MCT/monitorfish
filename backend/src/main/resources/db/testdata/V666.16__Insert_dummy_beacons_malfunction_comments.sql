INSERT INTO beacon_malfunction_comments (beacon_malfunction_id, comment, user_type, date_time_utc) VALUES
...
(2,'Bon et bien encore un chalutage de fond...', 'OPS', NOW() - ('2 WEEK')::interval);
