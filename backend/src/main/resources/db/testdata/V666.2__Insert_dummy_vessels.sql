...
(2, 'FRA000461560','GV461590','QGDF','GR56','BREIZH LORD','X',5.0,12.89, 'Auray', 'AY', 123, 'LORIENT', 127, 'Pêche côtière', '3', 'Pêche', ARRAY['SDN', 'OTM'],  120, CURRENT_DATE, 'LE PELETIER', ARRAY['+33 6 84 56 32 14'], ARRAY['lepeletier@gmail.com'], 'EL MALIK', ARRAY['+33 6 45 25 14'], ARRAY['elmalik@gmail.com']),
