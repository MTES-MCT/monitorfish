COPY public.fishing_gear_codes (fishing_gear_code, fishing_gear, fishing_gear_category) FROM stdin;
MIS	Engin divers	Engin inconnu
NK	Engin inconnu	Engin inconnu
FOO	Pêche à pied	Pas d'engin
...
PTB	Chaluts-bœufs de fond	Chaluts
OTB	Chaluts de fond à panneaux	Chaluts
TBB	Chaluts à perche	Chaluts
DHS	Drague à main manœuvrée à partir du rivage	Dragues
DHB	Drague à main manœuvrée à partir du bateau	Dragues
HMD	Dragues mécanisées incluant les dragues suceuses	Dragues
DRH	Dragues à main utilisées à bord d'un bateau	Dragues
DRB	Dragues remorquées par bateau	Dragues
LNP	Filets soulevés portatifs	Filets soulevés
LN	Filets soulevés (non spécifiés)	Filets soulevés
GES	Tamis à civelles	Filets soulevés
LNS	Filets soulevés fixes manœuvrés du rivage	Filets soulevés
LNB	Filets soulevés manœuvrés par bateau	Filets soulevés
...
LTL	Lignes de traîne	Lignes et hameçons
LLD	Palangres dérivantes	Lignes et hameçons
...
MDR	Filets de rabattage	Engins divers
MSP	Epuisette	Engins divers
MPN	Pushnets (haveneau à crevettes)	Engins divers
MEL	Pêche électrique	Engins divers
OTP	Chaluts à panneaux multiples	Chaluts
NS	Non spécifié	Engin inconnu
DRM	Dragues mécanisées	Dragues
OTS	Inconnu FAO	Engin inconnu
SUX	Filets tournants (non spécifié)	Filets tournants
\.
