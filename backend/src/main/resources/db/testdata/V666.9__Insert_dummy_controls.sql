...
(13, '23584', 'Arreté du 18/01/3021', 'Sécurité', 'Défaut AIS');
...
VALUES 
(1, 1, 151,'Contrôle en mer',CURRENT_DATE,CURRENT_DATE,CURRENT_DATE,'Manche ouest - Atlantique',-6.56, 45.12, null, False, False, False, False, 'Navire contrôlé en janvier', True, ARRAY[22, 13], True, False, False, 'Pas de saisie', 'Commentaires post contrôle', '[{"gearCode": "OTB", "declaredMesh": 60.0, "controlledMesh": null, "gearWasControlled": false}, {"gearCode": "OTM", "declaredMesh": 60.0, "controlledMesh": 60.8, "gearWasControlled": true}]'),
(2, 1, 151,'Contrôle en mer',CURRENT_DATE,CURRENT_DATE,CURRENT_DATE,'Manche ouest - Atlantique',-8.52, 51.58, null, True, True, False, False, 'Aucun commentaire', False, null, False, False, False, 'Pas de saisie', 'Commentaires post contrôle', '[]'),
(3, 1, 12,'Contrôle à la débarque','2020-01-18T07:19:28.384921Z','2020-01-18T07:19:28.384921Z','2020-01-18T07:19:28.384921Z','Manche est - Mer du nord',null, null, 'AEFAT', False, true, true, False, 'Contrôler les engins', True, ARRAY[5, 13, 61], False, False, True, 'Saisie de la pêche', 'Documents pas à jour', '[{"gearCode": "OTB", "declaredMesh": 60.0, "controlledMesh": 58.9, "gearWasControlled": true}]');
