...
(3, 1, 12,'Contrôle à la débarque','2020-01-18T07:19:28.384921Z','2020-01-18T07:19:28.384921Z','2020-01-18T07:19:28.384921Z','Manche est - Mer du nord',null, null, 'AEFAT', False, true, true, False, 'Contrôler les engins', True, null, False, False, True, 'Saisie de la pêche', 'Documents pas à jour', '[{"gearCode": "OTB", "declaredMesh": 60.0, "controlledMesh": 58.9, "gearWasControlled": true}]');
