...
class GetAllBeaconMalfunctionsUTests {
    ...
    fun `execute Should return the beacon malfunctions filtered and enriched with the risk factor found in the last position table`() {
        ...
        given(beaconMalfunctionsRepository.findAllExceptArchived()).willReturn(listOf(
            ...
            BeaconMalfunction(3, "FR000123456", "999999", "CALLME",
        ...
        given(beaconMalfunctionsRepository.findLastSixtyArchived()).willReturn(listOf(
            BeaconMalfunction(4, "FR123456785", "9876543", "IRCS2",
