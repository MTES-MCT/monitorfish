...
class GetAllBeaconStatusesUTests {
    ...
    fun `execute Should return the beacon statuses enriched with the risk factor found in the last position table`() {
        ...
        val secondPosition = LastPosition(null, "FR224226855", "224226850", null, null, null, null, PositionType.AIS, 16.445, 48.2525, 1.8, 180.0, riskFactor = 1.54, dateTime = now.minusHours(3), vesselIdentifier = VesselIdentifier.INTERNAL_REFERENCE_NUMBER)
        ...
        given(beaconStatusesRepository.findAll()).willReturn(listOf(BeaconStatus(1, "FR224226850", "1236514", "IRCS",
        ...
        // Then
        assertThat(enrichedBeaconStatuses).hasSize(1)
