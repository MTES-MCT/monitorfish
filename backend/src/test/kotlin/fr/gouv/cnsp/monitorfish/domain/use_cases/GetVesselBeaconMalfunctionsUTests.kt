...
class GetVesselBeaconMalfunctionsUTests {
    ...
    fun `execute Should return the detailed beacon malfunctions for a given vessel`() {
        ...
        // When
        val enrichedBeaconMalfunctions = GetVesselBeaconMalfunctions(beaconMalfunctionsRepository, beaconMalfunctionCommentsRepository, beaconMalfunctionActionsRepository)
