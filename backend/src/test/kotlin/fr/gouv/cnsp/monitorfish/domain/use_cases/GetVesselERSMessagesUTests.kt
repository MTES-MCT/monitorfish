...
class GetVesselERSMessagesUTests {
    ...
    fun `execute Should return an ordered list of last ERS messages with the codes' names`() {
        // Given
        given(ersRepository.findLastTripBeforeDateTime(any(), any())).willReturn(VoyageDatesAndTripNumber(123, ZonedDateTime.now(), ZonedDateTime.now()))
