...
class GetAllBeaconMalfunctionsUTests {
    ...
    fun `execute Should return the beacon malfunctions filtered and enriched with the risk factor found in the last position table`() {
        ...
        val firstPosition = LastPosition(
            null, "FR224226850", "224226850", null, null, null, null, PositionType.AIS, 16.445, 48.2525, 1.8, 180.0, riskFactor = 1.23,
        ...
        val secondPosition = LastPosition(
            null, "FR123456785", "224226850", null, null, null, null, PositionType.AIS, 16.445, 48.2525, 1.8, 180.0, riskFactor = 1.54,
            dateTime = now.minusHours(
                3
            ),
            vesselIdentifier = VesselIdentifier.INTERNAL_REFERENCE_NUMBER
        ...
        val thirdPosition = LastPosition(
            null, "FR224226856", "224226850", null, null, null, null, PositionType.AIS, 16.445, 48.2525, 1.8, 180.0, riskFactor = 1.98,
            dateTime = now.minusHours(
                2
            ),
            vesselIdentifier = VesselIdentifier.INTERNAL_REFERENCE_NUMBER
        ...
        val fourthPosition = LastPosition(
            null, "FR224226857", "224226850", null, null, null, null, PositionType.AIS, 16.445, 48.2525, 1.8, 180.0, riskFactor = 1.24,
            dateTime = now.minusHours(
                1
            ),
            vesselIdentifier = VesselIdentifier.INTERNAL_REFERENCE_NUMBER
        ...
        given(beaconMalfunctionsRepository.findAllExceptArchived()).willReturn(
            listOf(
                ...
                BeaconMalfunction(
                    ...
                    beaconNumber = "123465", beaconStatusAtMalfunctionCreation = BeaconStatus.ACTIVATED, endOfBeaconMalfunctionReason = EndOfBeaconMalfunctionReason.RESUMED_TRANSMISSION
                ),
                BeaconMalfunction(
                    ...
                    ZonedDateTime.now(), null, ZonedDateTime.now(),
                    beaconNumber = "the now unsupervised beacon", beaconStatusAtMalfunctionCreation = BeaconStatus.ACTIVATED
                )
            )
        )
        given(beaconMalfunctionsRepository.findLastSixtyArchived()).willReturn(
            listOf(
                BeaconMalfunction(
                    ...
                    ZonedDateTime.now(), null, ZonedDateTime.now(),
                    beaconNumber = "another active beacon", beaconStatusAtMalfunctionCreation = BeaconStatus.ACTIVATED
                )
            )
        )
