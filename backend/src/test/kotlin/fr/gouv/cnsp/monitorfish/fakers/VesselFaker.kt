...
class VesselFaker {
    companion object {
        fun fakeVessel(
            ...
            operatorPhones: List<String> = listOf(),
            operatorEmail: String? = null,
            proprietorName: String? = null,
            proprietorPhones: List<String> = listOf(),
            proprietorEmails: List<String> = listOf(),
            vesselPhones: List<String> = listOf(),
            vesselEmails: List<String> = listOf(),
