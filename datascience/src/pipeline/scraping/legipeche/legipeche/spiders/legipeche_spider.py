...
class LegipecheSpider(scrapy.Spider):
    ...
    def parse(self, response):
        items = response.xpath('//div[@class="articles-list__item__content _content"]/a')
        location_menu = response.xpath('//div[@id="site-content"]/ul[@class="breadcrumb"]/li')
        ...
        for href in response.xpath('//div[@class="rubrique__list__item"]/ul/li/a/@href'):
