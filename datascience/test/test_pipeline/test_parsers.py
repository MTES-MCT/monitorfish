...
from src.pipeline.parsers.ers import parse_xml_string, ERSParsingError
...
class TestLogParsers(unittest.TestCase):
    ...
    def test_cor_parser(self):
        ...
        value = data["value"]
        self.assertEqual(set(value), {'landingDatetimeUtc', 'port', 'sender', 'catchLanded'})
    ...
    def test_cro_parser(self):
        ...
        expected_value = {
            ...
            'effortZoneExitDatetimeUtc':
            '2020-03-23T22:05:00Z',
            'targetSpeciesOnExit': None,
            'faoZoneExited': '27.8.c',
            'economicZoneExited': 'ESP',
    ...
    def test_dis_parser(self):
        ...
        expected_value = {
            ...
            'catches': [
                {'species': 'GAG', 'weight': 70.0, 'nbFish': None, 
                 'faoZone': '27.7.j.2', 'economicZone': 'IRL', 
                 'statisticalRectangle': '30D9', 'effortZone': None, 
                 'presentation': 'WHL', 'packaging': None, 
                 'freshness': None, 'preservationState': 'ALI', 
                 'conversionFactor': 1.0}, 
                {'species': 'RJB', 'weight': 130.0, 'nbFish': None, 
                 'faoZone': '27.7.j.2', 'economicZone': 'IRL', 
                 'statisticalRectangle': '30D9', 'effortZone': None, 
                 'presentation': 'WHL', 'packaging': None, 
                 'freshness': None, 'preservationState': 'ALI', 
    ...
    def test_far_parser(self):
        ...
        value = data["value"]
        self.assertEqual(set(value), {'dimensions', 'farDatetimeUtc', 'gear', 'mesh', 'catches'})
    ...
    def test_pno_parser(self):
        ...
        self.assertEqual(
            set(value), 
            {'catchOnboard', 'predictedArrivalDatetimeUtc', 
             'tripStartDate', 'port', 'purpose'})
