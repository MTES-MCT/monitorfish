...
def test_control_anteriority_flow(reset_test_data):
    ...
    expected_control_anteriority = pd.DataFrame(
        {
            "vessel_id": [1, 2, 3],
            "cfr": ["ABC000306959", "ABC000542519", "ABC000055481"],
            "ircs": ["LLUK", "FQ7058", "IL2468"],
            "external_immatriculation": ["RV348407", "RO237719", "AS761555"],
            "last_control_datetime_utc": [
                now - relativedelta(months=3),
                now - relativedelta(months=3),
                now - relativedelta(weeks=1),
            ],
            "last_control_infraction": [True, True, False],
            ...
            "number_recent_controls": [2.391423, 6.541971, 0.993613],
            "control_rate_risk_factor": [1.750000, 1.750000, 2.500000],
            "infraction_score": [-4.500000, -5.500000, -1.000000],
            "infraction_rate_risk_factor": [1.0, 1.0, 1.0],
            "number_controls_last_5_years": [6, 11, 1],
            "number_controls_last_3_years": [5, 11, 1],
            "number_infractions_last_5_years": [6, 1, 0],
            "number_diversions_last_5_years": [1, 0, 0],
            "number_seizures_last_5_years": [1, 1, 0],
            "number_escorts_to_quay_last_5_years": [1, 0, 0],
        }
    )
