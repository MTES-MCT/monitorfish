...
context('BackOffice > Regulation Form > Creation', () => {
  ...
  it('Should send the expected request when creating a regulation with a complex period', () => {
    ...
    cy.contains('Dates précises')
      ...
      .click({ force: true })
      .wait(250)
      .type('15112024', { delay: 500, force: true })
    cy.contains('Dates précises').parent().parent().find('a').eq(0).click()
    cy.contains('Dates précises')
      .parent()
      .parent()
      .find('input')
      ...
      .click({ force: true })
      .wait(250)
      .type('20112024', { delay: 500, force: true })
  })
})
