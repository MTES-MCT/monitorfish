...
context('Vessel sidebar reporting tab', () => {
  ...
  it('Reporting Should contain the current reporting and archive a reporting', () => {
    // Given
  ...
  it('Reporting Should be deleted and not found in the archived reporting not in the map', () => {
