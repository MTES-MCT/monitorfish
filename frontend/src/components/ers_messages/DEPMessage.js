                    ...
                    <Fields>
                        <TableBody>
                            <Field>
                                ...
                                <Value>{props.message.departureDatetimeUtc ? <>{getDateTime(props.message.departureDatetimeUtc, true)}</> : <NoValue>-</NoValue>}</Value>
                            </Field>
                            <Field>
                    ...
                    <Fields>
                        <TableBody>
                            <Field>
                                ...
                                <Value>{props.message.gearOnboard && props.message.gearOnboard.length ?
                                    props.message.gearOnboard.map(speciesCatch => {
                                        return <span key={speciesCatch.gear}>
                                        {
                                            speciesCatch.gearName ?
                                                <>{speciesCatch.gearName} ({speciesCatch.gear})</> : speciesCatch.species
                                        }
                                        <br/>
                                    </span>
