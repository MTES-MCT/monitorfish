  ...
  getHealthcheckFromAPI()
    .then(healthCheck => {
      ...
      const warning = getWarningText(
        ...
        positionsReceivedMinutesAgo,
        lastPositionsMinutesAgo,
        healthCheck,
      )
...
function getWarningText(
  ...
  if (
    (lastPositionsMinutesAgo > TEN_MINUTES || positionsReceivedMinutesAgo > TEN_MINUTES) &&
