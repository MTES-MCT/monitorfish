import { addZoneSelected } from '../../../../features/VesselList/slice'
...
const getAdministrativeZoneGeometry =
  (administrativeZoneCode, subZoneCode, zoneName, namespace) => (dispatch, getState) => {
    ...
    getAdministrativeZoneFromAPI(administrativeZoneCode, null, subZoneCode, getState().global.isBackoffice)
