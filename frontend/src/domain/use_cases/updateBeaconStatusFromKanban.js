...
/**
 * Update a beacon status from the side window kanban
 ...
 */
const updateBeaconStatusFromKanban = (id, nextBeaconStatus, updatedFields) => (dispatch, getState) => {
...
export default updateBeaconStatusFromKanban
