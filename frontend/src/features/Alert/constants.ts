export enum PendingAlertValueType {
  AIS_ACTIVITY_ON_VESSEL_NOT_EMITTING_VMS_ALERT = 'AIS_ACTIVITY_ON_VESSEL_NOT_EMITTING_VMS_ALERT',
  DECLARED_FISHING_ACTIVITY_DURING_BEACON_MALFUNCTION = 'DECLARED_FISHING_ACTIVITY_DURING_BEACON_MALFUNCTION',
