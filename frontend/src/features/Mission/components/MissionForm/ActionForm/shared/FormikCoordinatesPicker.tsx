import { InteractionListener, OpenLayersGeometryType } from '@features/MainMap/constants'
import { getCoordinatesExtent } from '@features/MainMap/useCases/getCoordinatesExtent'
import { convertToGeoJSONGeometryObject } from '@features/MainMap/utils'
