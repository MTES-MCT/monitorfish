...
export const MissionActionSchema = z.strictObject({
  ...
  emitsAis: z.enum(MissionAction.ControlCheck).optional(),
  emitsVms: z.enum(MissionAction.ControlCheck).optional(),
  ...
  separateStowageOfPreservedSpecies: z.enum(MissionAction.ControlCheck).optional(),
