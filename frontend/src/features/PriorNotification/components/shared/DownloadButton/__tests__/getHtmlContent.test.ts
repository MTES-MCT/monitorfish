...
describe('PriorNotificationCard/utils.getHtmlContent()', () => {
  it('Should format the HTML template', () => {
    ...
    const pno: Logbook.PnoMessage = {
      ...
      operationType: OperationType.DAT,
...
<!DOCTYPE html><html lang="fr">
  ...
  it('Should format the HTML template when purpose is not LAN', () => {
    // Given
    const pno: Logbook.PnoMessage = {
      acknowledgment: undefined,
      activityDateTime: '2024-06-14T06:52:22.978603Z',
      ...
      message: {
        ...
        faoZone: undefined,
        hasPortEntranceAuthorization: false,
        hasPortLandingAuthorization: undefined,
        isBeingSent: false,
        isInvalidated: false,
        isInVerificationScope: false,
        isSent: false,
        ...
        portName: 'Vannes',
        predictedArrivalDatetimeUtc: '2024-06-14T10:07:22Z',
        predictedLandingDatetimeUtc: undefined,
        purpose: PurposeCode.OTH,
        riskFactor: 1.2,
        statisticalRectangle: undefined,
        tripStartDate: '2024-06-13T21:07:22Z',
        updatedAt: undefined,
...
<!DOCTYPE html><html lang="fr">
  ...
  it('Should format the HTML template when isZero', () => {
    // Given
    const pno: Logbook.PnoMessage = {
      acknowledgment: undefined,
      activityDateTime: '2024-06-14T06:52:22.978603Z',
...
<!DOCTYPE html><html lang="fr">
  ...
  <body>
    <header>
      <h1>
        <p>PREAVIS - Débarquement (préavis zéro)</p>
        <p>
        VIVA ESPANA
        <img id="state_flag_icon" src="flags/es.png" />
        </p>
