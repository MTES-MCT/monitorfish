...
const archiveReportings = ids => async (dispatch, getState) => {
  ...
  return archiveReportingsFromAPI(ids)
    .then(() => {
      ...
      if (vesselIdentity && currentAndArchivedReportingsOfSelectedVessel.current?.length) {
        const archivedReportingsOfSelectedVessel = getArchivedReportingsOfSelectedVesselFromIds(
          ids,
        ...
        const nextCurrentAndArchivedReporting = getUpdatedCurrentAndArchivedReportingOfSelectedVessel(
          currentAndArchivedReportingsOfSelectedVessel,
          archivedReportingsOfSelectedVessel
        )
        dispatch(
