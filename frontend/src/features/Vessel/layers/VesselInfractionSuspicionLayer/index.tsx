...
} from '@features/Vessel/layers/VesselInfractionSuspicionLayer/constants'
...
function UnmemoizedVesselInfractionSuspicionLayer({ mapMovingAndZoomEvent }) {
      ...
      const updateFeatures = throttle(() => {
        ...
        const features = vesselsFeaturesInExtent
          ...
          .map(feature => {
            ...
            nextFeature.setId(
              `${LayerProperties.VESSEL_INFRACTION_SUSPICION.code}:${getVesselCompositeIdentifier(
...
export const VesselInfractionSuspicionLayer = React.memo(UnmemoizedVesselInfractionSuspicionLayer)
