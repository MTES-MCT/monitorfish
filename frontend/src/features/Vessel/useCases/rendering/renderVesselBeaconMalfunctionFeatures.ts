...
import { VESSEL_BEACON_MALFUNCTION_VECTOR_SOURCE } from '@features/Vessel/layers/VesselBeaconMalfunctionLayer/constants'
...
export const renderVesselBeaconMalfunctionFeatures = (): MainAppThunk => async (_, getState) => {
