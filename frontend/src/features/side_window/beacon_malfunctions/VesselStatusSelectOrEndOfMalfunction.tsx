...
type VesselStatusSelectOrEndOfMalfunctionProps = {
  beaconMalfunction: BeaconMalfunction
  domRef: any
  isAbsolute: boolean
  isMalfunctioning: boolean
  showedInCard: boolean
...
export function VesselStatusSelectOrEndOfMalfunction({
  ...
  updateVesselStatus,
  vesselStatus
}: VesselStatusSelectOrEndOfMalfunctionProps) {
...
const endOfMalfunctionStyle: (endOfBeaconMalfunctionReason, showedInCard: boolean) => CSSProperties = (
