...
function InfractionsResume({ numberOfDiversions, numberOfEscortsToQuay, numberOfSeizures }) {
  const getText = value => (!isNaN(value) ? value : <NoValue>-</NoValue>)
...
export default InfractionsResume
