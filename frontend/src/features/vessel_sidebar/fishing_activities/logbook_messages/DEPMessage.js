            ...
            <Fields>
              <TableBody>
                <Field>
                  ...
                  <Value>
                    {props.message.departureDatetimeUtc ? (
                      <>
                        {getDateTime(props.message.departureDatetimeUtc, true)} <Gray>(UTC)</Gray>
                      </>
                    ) : (
                      <NoValue>-</NoValue>
                    )}
                ...
                <Field>
                  ...
                  <Value>
                    {props.message.anticipatedActivity ? (
                      <>
                        {LogbookMessageActivityType[props.message.anticipatedActivity]} (
                        {props.message.anticipatedActivity})
                      </>
                    ) : (
                      <NoValue>-</NoValue>
            ...
            <Fields>
              <TableBody>
                <Field>
                  ...
                  <Value>
                    {props.message.speciesOnboard && props.message.speciesOnboard.length ? (
