            ...
            <Fields>
              <TableBody>
                <Field>
                  ...
                  <Value>
                    {props.message.discardDatetimeUtc ? (
                      <>
                        {getDateTime(props.message.discardDatetimeUtc, true)} <Gray>(UTC)</Gray>
                      </>
                    ) : (
                      <NoValue>-</NoValue>
                    )}
                ...
                <Field>
                  ...
                  <Value>
                    ...
                    {props.message.latitude && props.message.longitude ? (
                      getCoordinates(
                        [props.message.longitude, props.message.latitude],
                        WSG84_PROJECTION,
                        coordinatesFormat,
                      )[0]
                    ) : (
