...
function VesselIdentity() {
  ...
  useEffect(() => {
    if (selectedVessel) {
      ...
      } else if (!vesselsAreEquals(selectedVessel, vessel)) {
        ...
        <Fields>
          <TableBody>
            <Field>
              <Key>Nationalité</Key>
              <TrimmedValue>
                {vessel?.flagState && countries.getName(vessel?.flagState, 'fr') ? (
        ...
        <Fields>
          <TableBody>
            <Field>
              <Key>Taille</Key>
              <Value>
                {vessel?.length ? vessel?.length : <NoValue>-</NoValue>} x{' '}
                {vessel?.width ? vessel?.width : <NoValue>-</NoValue>}
              </Value>
            </Field>
            <Field>
              <Key>Jauge</Key>
                ...
                <PersonalData>
                  {vessel?.proprietorName ? (
                    <>
                      {vessel?.proprietorName}
                      <span>
                        {vessel?.proprietorPhones ? (
                          <>
                            <br />
                            {vessel?.proprietorPhones.join(', ')}
                          </>
                        ) : (
                          ''
                        )}
                      </span>
                      {vessel?.proprietorEmails ? (
                        <>
                          <br />
                          {vessel?.proprietorEmails.join(', ')}
                        </>
                      ) : (
                        ''
                      )}
                ...
                <PersonalData>
                  {vessel?.operatorName ? (
                    <>
                      {vessel?.operatorName}
                      <span>
                        {vessel?.operatorPhones ? (
                          <>
                            <br />
                            {vessel?.operatorPhones.join(', ')}
                          </>
                        ) : (
                          ''
                        )}
