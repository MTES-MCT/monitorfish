...
export function parseOrReturn<T>(body: unknown, schema: z.ZodType<any>, isArray: false): T
export function parseOrReturn<T>(body: unknown, schema: z.ZodType<any>, isArray: true): T[]
