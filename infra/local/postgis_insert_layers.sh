...
PGCLIENTENCODING=LATIN1 psql -d cnsp -U adl -f backend/src/main/resources/db/layersdata/Insert_fao_areas.sql
PGCLIENTENCODING=LATIN1 psql -d cnsp -U adl -f backend/src/main/resources/db/layersdata/Insert_eez_areas.sql
