...
* To update the documentation, simply edit the ``.rst`` source file in ``pipeline/docs/source``.
* To build the documentation locally and see the result of your updates :
  ...
  * build the html documentation with :
  ...
  This builds the documentation in ``pipeline/docs/build/html``. You can view the built documentation in english and in french by opening ``en/index.html`` and ``fr/index.html`` in a web browser.
...
* in ``pipeline/docs``, run (with your API token instead of ``$TOKEN``) :
