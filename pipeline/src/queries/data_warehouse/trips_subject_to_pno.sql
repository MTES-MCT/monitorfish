WITH fra_catches AS (
    SELECT
        ...
        c.trip_number,
        t.pno_type_name,
        t.minimum_notification_period AS minimum_notification_period_,
...
SELECT
    cfr,
    trip_number,
    MAX(minimum_notification_period_) AS minimum_notification_period
