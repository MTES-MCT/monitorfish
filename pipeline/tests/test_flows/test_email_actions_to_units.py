...
from src.entities.control_units import (
    ControlUnit,
    ControlUnitActions,
    ControlUnitActionsSentMessage,
)
from src.entities.missions import FlightGoal
from src.flows.email_actions_to_units import (
    control_unit_actions_list_to_df,
    create_email,
    email_actions_to_units_flow,
...
def test_render_html(sample_control_unit_actions):
    template = get_template()
    html = render(control_unit_actions=sample_control_unit_actions, template=template)
...
@patch("src.helpers.emails.sleep")
def test_send_mission_actions_email(
    ...
    sent_messages = send_mission_actions_email(
...
def test_control_unit_actions_list_to_df(
    ...
    df = control_unit_actions_list_to_df(control_unit_actions_sent_messages)
...
def test_load_emails_sent_to_control_units(
    ...
    load_emails_sent_to_control_units(control_unit_actions_sent_messages_df)
...
def test_flow(reset_test_data):
    ...
    state = email_actions_to_units_flow(
        test_mode=False,
        is_integration=True,
